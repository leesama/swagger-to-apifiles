...
export interface definitions {
  ...
  PartnerGroupVO: {
    ...
    origin?:
      | 
      {
        name: "OriginEnumType.LOCAL(type=0, origin=local)";
        message: string;
        code: "OriginEnumType.LOCAL(type=0, origin=local)";
      }
      | 
      {
        name: "OriginEnumType.REMOTE(type=1, origin=remote)";
        message: string;
        code: "OriginEnumType.REMOTE(type=1, origin=remote)";
      };
    /** show_ignore */
    showIgnore?: number;
    /** show_market */
